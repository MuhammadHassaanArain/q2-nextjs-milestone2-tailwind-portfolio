  ...
  return (
    <main className="w-screen bg-bgdark py-14 flex justify-center">
      <section className="text-center md:w-3/5">
        <h2 className="text-accentOrange text-3xl md:text-4xl py-4 font-extrabold font-mono">Crafting Seamless Web Experiences</h2>
        <h3 className="text-textLight text-xl md:text-2xl py-4">
